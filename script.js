...
function selectAnswer(selectedOption, correntAnswer) {
    const options = optionsElement.querySelectorAll("li");
    options.forEach(option => {
        option.classList.add(option.textContent === correntAnswer ? "correct" : "incorrect");
        option.style.pointerEvents = "none";
    });

    if(selectedOption.textContent === correntAnswer) 
        {
            score++;
